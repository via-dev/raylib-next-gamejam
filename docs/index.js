...
// include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmpbgj2t3bh.js
...
// end include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmpbgj2t3bh.js
// include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmpvaaokrd_.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmpvaaokrd_.js
// include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmp8eucsi9q.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\luisjosemarquesborge\AppData\Local\Temp\tmp8eucsi9q.js
...
var _game_frame = Module['_game_frame'] = createExportWrapper('game_frame', 0);
